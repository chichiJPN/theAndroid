...
public class Guardian_Service extends Service {
    ...
    private void setLastLocation(Location location){
        ...
        numStepObject.put("lastLatitude", location.getLatitude());
        numStepObject.put("lastLongitude", location.getLongitude());
    ...
    class MyLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            //Toast.makeText(Guardian_Service.this, "Speed:"+location.getSpeed(), Toast.LENGTH_LONG).show();
