...
public class Guardian_DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout remind_container = (LinearLayout) findViewById(R.id.remind_container);
        final LinearLayout tasks_container = (LinearLayout) findViewById(R.id.tasks_container);
        final LinearLayout steps_taken_container = (LinearLayout) findViewById(R.id.steps_taken_container);
        progress.show();
		mDatabase.child("users").child(childID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot child) {
                ...
                setSteps(assignments);

                progress.dismiss();
            }

            private void setSteps(DataSnapshot assignments) {
                if (!assignments.child("Steps").exists()) {
                    return;
                }
                ...
                tvTask.setText("" + steps.getNumCompletionForReward() + " steps per day");
            ...
            public void setReminders(DataSnapshot assignments) {
                ...
                for (DataSnapshot reminderSnapshot : reminders.getChildren()) {
                    ...
                    Db_assignment reminder = reminderSnapshot.getValue(Db_assignment.class);
                    ...
                    reminderRow.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Log.d("Reminder name", " is " + reminderName);
                        }
                    });
                    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.FILL_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                    params.height = 100;
            ...
            public void setTasks(DataSnapshot assignments) {
                ...
                for (DataSnapshot taskSnapshot : tasks.getChildren()) {
                    ...
                    Db_assignment task = taskSnapshot.getValue(Db_assignment.class);
                    ...
                    taskRow.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Log.d("Reminder name", " is " + taskName);
                        }
                    });
